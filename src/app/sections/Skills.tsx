...
export default function Skills() {
  const skillList: SkillsListProp[] = [
    ...
    return (
      <section id="skills" className="sm:min-h-[90vh] p-4 sm:p-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-8 justify-center items-center">
          {skillList.map((item) => (
